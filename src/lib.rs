...
/// Get fields names and value refs
/// 
/// # Implementing
/// 
/// ```
...
/// 
/// ```
/// myenum.get_fields_mut() -> Vec<&mut dyn std::any::Any> /* Return mutable field values */
/// myenum.get_named_fields_mut() -> Vec<(&'static str, &mut dyn std::any::Any)> /* Return field names and mutable field values */
/// ```
/// # Example
/// 
/// ```
...
/// Get field names and mutable values
/// 
/// # Implementing
/// 
/// ```
/// #[derive(EnumReflectMut)]
/// enum ExampleEnumMut;
/// ```
/// # Functions
/// 
